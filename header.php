...
<script src="https://unpkg.com/jarallax@1.10/dist/jarallax-element.min.js"></script>
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=UA-129587290-1"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-129587290-1');
  </script>
  ...
  })(window,document,'script','dataLayer','GTM-MSF4JFX');</script>
...
<body style="width: auto;">
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MSF4JFX"
